...
#[derive(Accounts)]
pub struct ClaimAfterTimeoutSol<'info> {
    ...
    /// CHECK: address-bound to receive the rent refund.
...
pub fn claim_after_timeout_sol_handler(ctx: Context<ClaimAfterTimeoutSol>) -> Result<()> {
